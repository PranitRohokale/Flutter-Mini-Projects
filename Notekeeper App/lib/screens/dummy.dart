...
// note : if dtats is list then use json.decode
// note :if response.data ia {} then use jsonDecode()
        ...
        child: ClipRRect(
          ...
          child: ListTile(
            ...
            trailing: Checkbox(
              onChanged: (value) {
                setState(() {
                  row.completed = value ? 'true' : 'false';
                });
              },
              activeColor: Theme.of(context).primaryColor,
              value: row.completed == 'true' ? true : false,
            ),
            tileColor: Colors.grey.shade200,
            onTap: () => print("on Tap List"),
          ),
        ),
      ),
    );
